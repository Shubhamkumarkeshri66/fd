    ...
    <Container>
      ...
      >
        <DMBox
          ...
          pl={{ xs: 0, lg: 1 }}
        >
          <DMTypography variant="button" fontWeight="bold" color={light ? "white" : "dark"}>
            Aatithya
          </DMTypography>
        </DMBox>
        <DMBox color="inherit" display={{ xs: "none", lg: "flex" }} m={0} p={0}>
        ...
        {action &&
          (action.type === "internal" ? (
            <DMBox display={{ xs: "none", lg: "inline-block" }}>
              <DMButton
                component={Link}
                to={action.route}
                variant="gradient"
